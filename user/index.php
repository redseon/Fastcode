...
<dialog id="popup">
    <div class="modal_box">
      <div class="modal_list">
        ...
        <hr />
        <h2>※ USER 사용자 사이트 : 아이디- hong / 비밀번호- 0000</h2>
        <hr />
        ...
        <div class="modal_info">
          ...
          <p>
            ...
            <br /><a href="lecture/lecture_list.php">강좌리스트</a> / <a href="leture/lecture_view.php?lecid=23">강좌 상세보기</a> / <a href="cart/cart.php">장바구니</a> / <a href="class/myclass.php">나의 강의실</a> / <br/><a href="class/class_view.php">나의 강좌 보기</a> / <a href="member/login.php">로그인</a> / <a href="member/signup.php">회원가입</a> / <a href="index.php">Fastcode 메인</a>
          </p>
          <p><strong>팀원 :</strong> <span class="highlight">장선홍</span>, 오*경, 박*지, 손*진</p>
        </div>
        <hr />
        <div class="modal_info_part">
          <strong>파트 분담</strong>
          <p><strong>기획 :</strong> 전원 참여</p>
          <a href="lecture/lecture_list.php"><p><span class="highlight"><strong>강좌 리스트 페이지 디자인 & 구현 :</strong> 장선홍</span></p></a>
          <a href="leture/lecture_view.php?lecid=26"><p><span class="highlight"><strong>강좌 상세보기 페이지 디자인 & 구현 :</strong> 장선홍</span></p></a>
